...
class User(db.Model):
    ...
    kids_okay = db.Column(db.Boolean)
    dogs_okay = db.Column(db.Boolean)
    friendly_or_stakes_game = db.Column(db.String)
    type_of_game = db.Column(db.String)
    alcohol_okay = db.Column(db.Boolean)
    tobacco_okay = db.Column(db.Boolean)
    smoke_420_okay = db.Column(db.Boolean)
